...
A campaign records the first case's Node, package, direct runtime dependency, lockfile, and native-binding hashes. The adapter verifies the identity before and after every build, and the campaign aborts if it changes between cases.
